...
.icon-box.border .icon {
 ...
 <!-- Inspiro Slider -->
        <div id="slider" class="inspiro-slider slider-halfscreen arrows-large arrows-creative dots-creative" data-height-xs="360" data-autoplay-timeout="2600" data-animate-in="fadeIn" data-animate-out="fadeOut" data-items="2" data-loop="true" data-autoplay="true">
            <!-- Slide 1 -->
            <div class="slide background-image" style="background-image:url('images/banner1.jpg');">
                <div class="container">
                    <div class="slide-captions">
                        <!-- Captions -->
                             <h6>WELCOME TO</h6>
                                    <h2 class="text-uppercase text-medium">WELCOME TO POLO</h2>
                                    <p class="lead">Lorem ipsum dolor sit amet, consecte adipiscing elit.
                                        <br /> Suspendisse condimentum porttitor cursumus.</p>
                        <a class="btn" href="http://themeforest.net/item/polo-responsive-multipurpose-html5-template/13708923">Purchase POLO</a>
            ...
            <!-- end: Slide 1 -->
            <!-- Slide 2 -->
            <div class="slide background-image" style="background-image:url('images/banner2.jpg');">
                <div class="container">
                    <div class="slide-captions">
                        <!-- Captions -->
                        <h6>WELCOME TO</h6>
        ...
        <section class="row background-grey text-center">
            <div class="container">
                <h3>Welcome to Kohinoor Seeds</h3>
                ...
                <a href="product.php" class="btn"><span>View Products</span></a>
            </div>
        </section>
        <!-- CALL TO ACTION -->
        ...
        <!-- PORTFOLIO -->
        <section class="p-b-0">
            <div class="container"><div id="portfolio" class="grid-layout portfolio-3-columns" data-margin="40">
